...
//	int n;
//	double f = 1;
//	std::cout << "¬ведите число: "; std::cin >> n;
//	for (int i = 1; i <= n; i++)
//	{
//		std::cout << i << "! = ";
//		f *= i;
...
//	}
//	std::cout << endl;
//	//ѕо задумке он должен был выводить пример, но € туплю
//#endif // factorial
//#ifdef stepen
//	double a, b, result;
//
//	std::cout << "¬ведите основное число: "; std::cin >> a;
//	std::cout << "¬ведите показатель степени: "; std::cin >> b;
//	result = pow(a, b);
//	std::cout << a << " в степени " << b << " ровн€етс€: " << result << endl;
//
//	double a; // основание 
//	int n; //показатель степени
//
//	cout << "¬ведите основание степени: "; cin >> a;
//	cout << "¬ведите покзатель степени: "; cin >> n;
//	double N = 1;
//	if (n < 0)
//	{
//		a = 1 / a;
...
//	double b = 1;
//	double other_number;
//	std::cout << "¬ведите предел дл€ ‘ибоначчи: "; std::cin >> limit;
//	std::cout << "–€д ‘ибоначчи будет выведен до: " << limit << endl;
//
//	if (a <= limit)
//	{
//		std::cout << a << " ";
...
//
//	int n;
//	cout << "¬ведите предел дл€ р€да фибоначи: "; cin >> n;
...
//	double a = 0;
//	double b = 1;
//	std::cout << "¬ведите количество чисел которое будет выведено в р€ду ‘ибоначчи: "; std::cin >> n;
...
//
//	int n;
//	cout << "¬ведите количетсво чисел из р€да фибоначи: "; cin >> n;
